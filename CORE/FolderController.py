...
class FolderController:
    ...
    def generateFolders(self):
        folders = [
            ...
            "DATA\\ECONOMIA",
            "DATA\\ECONOMIA\\TACCOUNTS",
            f"DATA\\ECONOMIA\\TACCOUNTS\\{self.timeUtil.getCurrentYYYY()}",
            "DATA\\ECONOMIA\\CAJA",
            ...
            "DATA\\DISTRIBUCIONTIEMPO\\HORARIO",
            f"DATA\\DISTRIBUCIONTIEMPO\\HORARIO\\{self.timeUtil.getCurrentYYYY()}",
            "DATA\\PERFIL",
            "DATA\\NEURONAS",
            "DATA\\USOS",
            "DATA\\DRUGS",
