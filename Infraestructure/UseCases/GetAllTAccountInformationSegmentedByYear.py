...
2026
"""
from Application.UseCases.IGetAllTAccountInformationSegmentedByYear import IGetAllTAccountInformationSegmentedByYear
...
class GetAllTAccountInformationSegmentedByYear(IGetAllTAccountInformationSegmentedByYear):
    ...
    def execute(self, base_path: str) -> Response:
        try:
            ...
            for i in _data_by_YYYY["data"]:
                ...
                if _YYYY not in _final_data.keys():
                    _final_data[_YYYY] = {}
